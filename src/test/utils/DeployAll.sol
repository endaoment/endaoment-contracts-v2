...
contract DeployAll {
  ...
  function setUp() public virtual {
    ...
    distributor = new RollingMerkleDistributor(IERC20(address(ndao)), initialRoot, initialPeriod, globalTestRegistry);
    baseDistributor = new RollingMerkleDistributor(IERC20(address(baseToken)), initialRoot, initialPeriod, globalTestRegistry);
  }
}
